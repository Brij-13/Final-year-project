...
if(isset($_POST['signup']))
{
	...
	$a=date('Y-m-d');
	$msg=mysqli_query($con,"insert into users(mobile,email,password,date) values('$mobile','$email','$enc_password','$a')");
if($msg)
{
...
if(isset($_POST['send']))
{
$row1=mysqli_query($con,"select email,password from users where email='".$_POST['email']."'");
